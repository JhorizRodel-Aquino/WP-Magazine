    ...
    <section>  
      <div class="container">
        ...
        <div class="grid grid-cols-2 gap-10 my-20">
          ...
          <p id="single-main-excerpt"><?php the_field('excerpt')?>
          </p>
        </div>
        ...
        <div class="flex items-center justify-between mb-10 " id="single-article-details">
          <div class="details">
            <ul >
              ...
              <li><span>Date:</span> <?php echo get_the_date('j M, Y')?></li>
              <li><span>Duration:</span> <?php the_field('duration')?></li>
            </ul>
          </div>
          <a href="#" class="block category" id="single-article-category"><?php echo wp_get_post_terms($post->ID, 'categories')[0]->name?></a>
        </div>
      ...
      <div class="container">
        ...
        <?php if($article->have_posts()) : while($article->have_posts()) : $article->the_post()?>
            ...
            <div class="p-10 grid-item">
                ...
                <p class="mb-10 line-clamp-4"><?php the_field('excerpt')?></p>
                <div class="details">
                <ul>
                    <li><span>Date:</span> <?php echo get_the_date('j M, Y')?></li>
                    <li><span>Duration:</span> <?php get_field('duration')?></li>
                </ul>
                </div>
            </div>
