      ...
      <section class="mb-20">
        <div class="container overflow-x-visible">
          ...
          >
            ...
            <?php $categories = get_terms(['taxonomy' => 'categories']);
            if($categories) {
          ...
          <div class="grid overflow-hidden md:grid-cols-3 article-grid">
            ...
            <div class="p-10 grid-item">
              ...
              <div class="flex items-center justify-between mb-10">
                ...
                <a href="#" class="category"><?php echo wp_get_post_terms($post->ID, 'categories', ['taxonomy' => 'categories'])[0]->name?></a>
              </div>
              ...
              >
              <p class="mb-10 line-clamp-4"><?php the_field('excerpt')?>
              </p>
              <div class="details">
                <ul>
